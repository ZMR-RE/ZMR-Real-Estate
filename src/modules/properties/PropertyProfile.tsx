...
export function PropertyProfile() {
  ...
  const { property, transactions, activity, loading, error, tab, setTab, saving, saveProperty } =
  ...
  return (
    <div>
      ...
      {tab === 'overview' && (
        <PropertyProfileOverviewTab property={property} saving={saving} onSave={saveProperty} />
      )}
