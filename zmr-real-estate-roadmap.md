...
- [x] 8.4 Tenant as a real linked-record table, linked to Lease/Unit — checkbox was left unchecked in 2cf5aea despite the tenants/tenant_units tables and full Tenant/TenantAssignment UI already being built and working; corrected here after verifying it live while building 8.5 on top of it
